 ...
 * La funzione leggere_stringa_tastiera è dichiarata in questo modulo ma viene usata nel modulo gestione_input_output per coerenza,
 * riceve in input una stringa e restituisce come output la stringa letta da tastiera.
